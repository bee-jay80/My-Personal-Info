...
# Parse DEBUG from environment (allow '1','true','yes')
DEBUG = os.getenv('DEBUG')
# Default allowed hosts to localhost and 127.0.0.1 in development when not set
...
# static/index.css and static/script.js are found during development.
STATICFILES_DIRS = [
    BASE_DIR / 'static',
]
